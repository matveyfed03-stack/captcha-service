...
// 	protoc        v6.32.1
// source: api/balancer/v1/BalancerV1.proto
...
func (RegisterInstanceRequest_EventType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_balancer_v1_BalancerV1_proto_enumTypes[0].Descriptor()
}

func (RegisterInstanceRequest_EventType) Type() protoreflect.EnumType {
	return &file_api_balancer_v1_BalancerV1_proto_enumTypes[0]
}
...
func (RegisterInstanceRequest_EventType) EnumDescriptor() ([]byte, []int) {
	return file_api_balancer_v1_BalancerV1_proto_rawDescGZIP(), []int{0, 0}
}
...
func (RegisterInstanceResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_api_balancer_v1_BalancerV1_proto_enumTypes[1].Descriptor()
}

func (RegisterInstanceResponse_Status) Type() protoreflect.EnumType {
	return &file_api_balancer_v1_BalancerV1_proto_enumTypes[1]
}
...
func (RegisterInstanceResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_api_balancer_v1_BalancerV1_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *RegisterInstanceRequest) Reset() {
	*x = RegisterInstanceRequest{}
	mi := &file_api_balancer_v1_BalancerV1_proto_msgTypes[0]
...
func (*RegisterInstanceRequest) Descriptor() ([]byte, []int) {
	return file_api_balancer_v1_BalancerV1_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegisterInstanceResponse) Reset() {
	*x = RegisterInstanceResponse{}
	mi := &file_api_balancer_v1_BalancerV1_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterInstanceResponse) Descriptor() ([]byte, []int) {
	return file_api_balancer_v1_BalancerV1_proto_rawDescGZIP(), []int{1}
}
...
var File_api_balancer_v1_BalancerV1_proto protoreflect.FileDescriptor

const file_api_balancer_v1_BalancerV1_proto_rawDesc = "" +
	"\n" +
	" api/balancer/v1/BalancerV1.proto\x12\vbalancer.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc4\x02\n" +
...
var (
	file_api_balancer_v1_BalancerV1_proto_rawDescOnce sync.Once
	file_api_balancer_v1_BalancerV1_proto_rawDescData []byte
)

func file_api_balancer_v1_BalancerV1_proto_rawDescGZIP() []byte {
	file_api_balancer_v1_BalancerV1_proto_rawDescOnce.Do(func() {
		file_api_balancer_v1_BalancerV1_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_balancer_v1_BalancerV1_proto_rawDesc), len(file_api_balancer_v1_BalancerV1_proto_rawDesc)))
	})
	return file_api_balancer_v1_BalancerV1_proto_rawDescData
}

var file_api_balancer_v1_BalancerV1_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_api_balancer_v1_BalancerV1_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_balancer_v1_BalancerV1_proto_goTypes = []any{
...
var file_api_balancer_v1_BalancerV1_proto_depIdxs = []int32{
...
func init() { file_api_balancer_v1_BalancerV1_proto_init() }
func file_api_balancer_v1_BalancerV1_proto_init() {
	if File_api_balancer_v1_BalancerV1_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_balancer_v1_BalancerV1_proto_rawDesc), len(file_api_balancer_v1_BalancerV1_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_balancer_v1_BalancerV1_proto_goTypes,
		DependencyIndexes: file_api_balancer_v1_BalancerV1_proto_depIdxs,
		EnumInfos:         file_api_balancer_v1_BalancerV1_proto_enumTypes,
		MessageInfos:      file_api_balancer_v1_BalancerV1_proto_msgTypes,
	}.Build()
	File_api_balancer_v1_BalancerV1_proto = out.File
	file_api_balancer_v1_BalancerV1_proto_goTypes = nil
	file_api_balancer_v1_BalancerV1_proto_depIdxs = nil
}
