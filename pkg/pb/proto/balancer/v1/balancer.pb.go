...
func (RegisterInstanceRequest_EventType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_balancer_v1_balancer_proto_enumTypes[0].Descriptor()
}

func (RegisterInstanceRequest_EventType) Type() protoreflect.EnumType {
	return &file_proto_balancer_v1_balancer_proto_enumTypes[0]
}
...
func (RegisterInstanceRequest_EventType) EnumDescriptor() ([]byte, []int) {
	return file_proto_balancer_v1_balancer_proto_rawDescGZIP(), []int{0, 0}
}
...
func (RegisterInstanceResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_balancer_v1_balancer_proto_enumTypes[1].Descriptor()
}

func (RegisterInstanceResponse_Status) Type() protoreflect.EnumType {
	return &file_proto_balancer_v1_balancer_proto_enumTypes[1]
}
...
func (RegisterInstanceResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_proto_balancer_v1_balancer_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *RegisterInstanceRequest) Reset() {
	*x = RegisterInstanceRequest{}
	mi := &file_proto_balancer_v1_balancer_proto_msgTypes[0]
...
func (*RegisterInstanceRequest) Descriptor() ([]byte, []int) {
	return file_proto_balancer_v1_balancer_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegisterInstanceResponse) Reset() {
	*x = RegisterInstanceResponse{}
	mi := &file_proto_balancer_v1_balancer_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterInstanceResponse) Descriptor() ([]byte, []int) {
	return file_proto_balancer_v1_balancer_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_balancer_v1_balancer_proto protoreflect.FileDescriptor

const file_proto_balancer_v1_balancer_proto_rawDesc = "" +
	"\n" +
	" proto/balancer/v1/balancer.proto\x12\vbalancer.v1\"\xc4\x02\n" +
	...
	"\x10RegisterInstance\x12$.balancer.v1.RegisterInstanceRequest\x1a%.balancer.v1.RegisterInstanceResponse\"\x00(\x010\x01B4Z2github.com/your-org/captcha-service/pb/balancer/v1b\x06proto3"

var (
	file_proto_balancer_v1_balancer_proto_rawDescOnce sync.Once
	file_proto_balancer_v1_balancer_proto_rawDescData []byte
)

func file_proto_balancer_v1_balancer_proto_rawDescGZIP() []byte {
	file_proto_balancer_v1_balancer_proto_rawDescOnce.Do(func() {
		file_proto_balancer_v1_balancer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_balancer_v1_balancer_proto_rawDesc), len(file_proto_balancer_v1_balancer_proto_rawDesc)))
	})
	return file_proto_balancer_v1_balancer_proto_rawDescData
}

var file_proto_balancer_v1_balancer_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_balancer_v1_balancer_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_balancer_v1_balancer_proto_goTypes = []any{
...
var file_proto_balancer_v1_balancer_proto_depIdxs = []int32{
...
func init() { file_proto_balancer_v1_balancer_proto_init() }
func file_proto_balancer_v1_balancer_proto_init() {
	if File_proto_balancer_v1_balancer_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_balancer_v1_balancer_proto_rawDesc), len(file_proto_balancer_v1_balancer_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_balancer_v1_balancer_proto_goTypes,
		DependencyIndexes: file_proto_balancer_v1_balancer_proto_depIdxs,
		EnumInfos:         file_proto_balancer_v1_balancer_proto_enumTypes,
		MessageInfos:      file_proto_balancer_v1_balancer_proto_msgTypes,
	}.Build()
	File_proto_balancer_v1_balancer_proto = out.File
	file_proto_balancer_v1_balancer_proto_goTypes = nil
	file_proto_balancer_v1_balancer_proto_depIdxs = nil
}
